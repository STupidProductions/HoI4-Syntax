...
- Reordered this file, newest to oldest instead of the other way around.
- Merged `loc.name.hoi4loc` into `string.hoi4loc` and reworked the latter to fix issues with highlighting inside strings.
    - Fixed the exception from version [1.3.1](#131---200425).
- Added `on_add` and `on_remove` to the effect highlighting.
